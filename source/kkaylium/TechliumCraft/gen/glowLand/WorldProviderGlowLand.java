...
public class WorldProviderGlowLand extends WorldProvider{
	
	private float[] colorsSunriseSunset = new float[4];

	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerHell(BiomesInit.glowBiome, this.dimensionId, this.dimensionId);
		this.dimensionId = Reference.GLOW_LAND_dimensionId;
		this.hasNoSky = false;
	}
	...
	public String getWelcomeMessage() {
		if ((this instanceof WorldProviderGlowLand)) {
			return "Entering Glow Land";
		}
		return null;
	}
