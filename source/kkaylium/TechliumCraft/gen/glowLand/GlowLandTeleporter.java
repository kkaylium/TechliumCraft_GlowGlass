...
public class GlowLandTeleporter extends Teleporter{
    ...
    public GlowLandTeleporter(WorldServer par1WorldServer)
    {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
            ...
            if (d3 >= 0.0D)
            {
                    if (flag)
                    {
                            this.destinationCoordinateCache.add(j1, new GlowLandPortalPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
