...
public class BlockGlowPlanks extends BlockContainer{
    ...
    public String[] iconNames = new String[] { "GPWhite", "GPBlack", "GPRed", "GPOrange", "GPYellow", "GPLime", "GPGreen", "GPSky", "GPBlue", "GPLilac", "GPPurple", "GPPink", "GPSpecial", "GPBase"};
    ...
    public void registerIcons(IconRegister iconregister)
    {
        ...
        blockIcon = iconregister.registerIcon("tcgg:GPBase");
    }
